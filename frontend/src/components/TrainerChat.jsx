...
const TrainerChat = () => {
  ...
  const startNewChat = async () => {
    if (
      window.confirm(
        "Are you sure you want to start a new chat? This will delete all previous messages."
      )
    ) {
      try {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 text-center shadow-2xl">
            ...
            <p className="text-white/80">
              Please log in to chat with your AI trainer.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 text-lg">
            Get personalized workout advice and motivation 💪
          </p>
        </div>
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="text-white/60 max-w-md">
                  I'm here to help you with workout plans, exercise form,
                  nutrition tips, and motivation. Ask me anything about fitness!
                </p>
              </div>
            ) : (
          ...
          {[
            {
              emoji: "💪",
              title: "Workout Plans",
              desc: "Get personalized routines",
            },
            {
              emoji: "✅",
              title: "Form Check",
              desc: "Improve your technique",
            },
            ...
            <div
              ...
              onClick={() =>
                setNewMessage(`Tell me about ${tip.title.toLowerCase()}`)
              }
            >
